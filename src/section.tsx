  ...
  return (
    <section id='section'>
        <form>
            ...
            <p className='visually-hidden' id='name-blank'>Can't be blank</p>
            <label htmlFor="number">Card Number</label>
            <input type='text' name='number' id='number' placeholder="e.g. 1234 5678 9123 0000"></input>
            <p className='visually-hidden' id='error-format'>Wrong format, numbers only</p>
            <p className='visually-hidden' id='number-blank'>Can't be blank</p>
            <div className="exp">
            <label htmlFor="exp-date">Exp. Date (MM/YY)</label>
            <input type='number' name='exp-date' id='exp-date' placeholder="MM" min='1' max='12'></input>
            <p className='visually-hidden' id='exp-date-blank'>Can't be blank</p>
            <input type='number' id='exp-date-year' name='exp-date-year' placeholder="YY" min='00' max='99'></input>
            <p className='visually-hidden' id='exp-date-year-blank'>Can't be blank</p>
            <label htmlFor="cvc" id='cvc-label'>CVC</label>
            <input type='number' name='cvc' id='cvc' placeholder="e.g. 123" min='000' max='999'></input>
            <p className='visually-hidden' id='cvc-blank'>Can't be blank</p>
            </div>
